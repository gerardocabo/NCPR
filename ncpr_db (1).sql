...
--
-- Table structure for table `disposition_tbl_intervention`
--

CREATE TABLE `disposition_tbl_intervention` (
  `id` int(11) NOT NULL,
  `ncpr_num` varchar(100) NOT NULL,
  `input_name` enum('affected_process','other_resumption','process_instruction','document_alert_s','other_specify_s','released_by','acknowledgment_signature','head_signature','prod_manager_signature') DEFAULT NULL,
  `inputted_data` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `dispo_table_intervention`
--

CREATE TABLE `dispo_table_intervention` (
  `id` int(11) NOT NULL,
  `ncpr_num` varchar(50) DEFAULT NULL,
...
CREATE TABLE `ncpr_table` (
  ...
  `status` enum('Open','Closed','Cancel','Canceled','Rejected') DEFAULT NULL,
...
--
-- Table structure for table `predefined_checkboxes_2`
--

CREATE TABLE `predefined_checkboxes_2` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `predefined_checkboxes_2`
--

INSERT INTO `predefined_checkboxes_2` (`id`, `key`, `name`) VALUES
(1, 'AT1', 'Problem solving/troubleshooting'),
(2, 'AT2', 'Process Verification/Engg Eval'),
(3, 'PD1', 'Resume Production'),
(4, 'PD2', 'Stop Production'),
(5, 'R1', 'Criteria'),
(6, 'R2', 'Method'),
(7, 'R3', 'Materials'),
(8, 'R4', 'Machine'),
(9, 'R5', 'Machine/fixture repair'),
(10, 'DR1', 'N/A'),
(11, 'DR2', 'WIS'),
(12, 'DR3', 'DJ'),
(13, 'DR4', 'PROC'),
...
(15, 'DR6', 'PFMEA'),
(16, 'F1', 'further_eval'),
(17, 'D_I1', 'Document Alert #'),
(18, 'D_I2', 'Other'),
(19, 'R6', 'Others - resumption_reason');
...
(875, '179357-001', 'Nikal PC3 Additive');
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `role_id`, `status`, `otp`, `created_at`, `person_id`, `last_seen_id`) VALUES
(2, 'jr.gerardo14@gmail.com', '$2y$10$TYELwL2PhUlikVxs2kh6OeE.oDpj91gEooI2pKY1FPwRaj.MYKsH.', '', 2, NULL, '', '2025-03-17 06:53:25', 0, 0),
...
(23, 'areaso', '$2y$10$8e/pTekoO5m/haH8EM4M5edAE8oDgTmcEZ0Rxc4Lf5FsAjYSum6dK', 'areaso@ntphil.com', 8, NULL, '', '2025-04-02 07:05:13', 6, 0),
(24, '016283', '$2y$10$pTS680z8Nta4HGzn.g0DletTJL1mV7qILubl0AZQyfVfLwWQiIWqS', 'mquijano@ntphil.com', 9, NULL, '', '2025-04-02 07:05:13', 7, 0),
(25, '207137', '$2y$10$0rci5jbRmUIQR9OGqng.RuGQUAsVJuvFKwO51OP6Z6FDv2mlR725O', 'qaengineer@ntphil.com', 7, NULL, '', '2025-04-02 07:05:13', 8, 0),
(26, '175558', '$2y$10$h6n5wi61AWRnHiB5u1tkSOk88yZvZpM8xOf1AuVoaAXcsNAJRrIey', 'qaengineer2@ntphil.com', 7, NULL, '', '2025-04-02 07:05:13', 9, 0),
(27, 'qaengineer3', '$2y$10$0GLe4djFUe3tcN8SxrQ06eRxJmCpy9STNv6.Pxdz7xHl20W4y9L1G', 'qaengineer3@ntphil.com', 7, NULL, '', '2025-04-02 07:05:13', 0, 0),
(28, '175590', '$2y$10$x86BxWqLAqOATbZZ5wQ7HOp/jfop6EKcVB/9CTvp6ZFautLB.CUGS', 'qastaff@ntphil.com', 6, NULL, '', '2025-04-02 07:05:14', 5, 0),
(29, '240035', '$2y$10$or03n/5fqpOZhwId8Kv3mOXh7aZCr2OEfSvFNXiKRygev5fBzDxhy', 'qastaff1@ntphil.com', 4, NULL, '', '2025-04-02 07:05:14', 3, 0),
(30, '144097', '$2y$10$RgOaGFCebFo/K1ZzBcapmeX/YvsQ.wF/KfvqCafA.1BHNY5jZu4qe', 'pcop1@ntphil.com', 5, NULL, '', '2025-04-02 07:05:14', 4, 0),
(32, '217331', '$2y$10$or03n/5fqpOZhwId8Kv3mOXh7aZCr2OEfSvFNXiKRygev5fBzDxhy', 'qastaff1@ntphil.com', 4, NULL, '', '2025-04-02 07:05:14', 2, 0);
...
--
-- Indexes for table `disposition_tbl_intervention`
--
ALTER TABLE `disposition_tbl_intervention`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `dispo_table_intervention`
--
...
--
-- Indexes for table `predefined_checkboxes_2`
--
ALTER TABLE `predefined_checkboxes_2`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `disposition_tbl_intervention`
--
ALTER TABLE `disposition_tbl_intervention`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `dispo_table_intervention`
--
ALTER TABLE `dispo_table_intervention`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
